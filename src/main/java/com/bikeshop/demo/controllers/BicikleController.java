...
public class BicikleController {
	...
	public String bicikleSort(Model model, HttpServletRequest request) {
		...
		if (BikeUtils.isEmpty(request.getParameter("kategorija")) == false) {
			bicikle = bicikleService.findByFieldListSort("kategorija_id", request.getParameter("kategorija"),
					request.getParameter("sort"), request.getParameter("order"));
		} else {
	...
	public String bicikleSearch(Model model, HttpServletRequest request) {
		...
		if (BikeUtils.isEmpty(request.getParameter("kategorija")) == false) {
			bicikle = bicikleService.findByFieldListSearch("kategorija_id", request.getParameter("kategorija"),
	...
	public String update(@Valid @ModelAttribute Bicikl kor, BindingResult bd, @PathVariable("id") int id,
			@RequestParam("slika") MultipartFile[] file, Model model) {
